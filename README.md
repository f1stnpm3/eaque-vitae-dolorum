...
[NPMURL]: https://npmjs.org/package/@f1stnpm3/eaque-vitae-dolorum "npm"
[NPMIMGURL]: https://img.shields.io/npm/v/@f1stnpm3/eaque-vitae-dolorum.svg?style=flat&longCache=true
[BuildStatusURL]: https://github.com/f1stnpm3/eaque-vitae-dolorum/actions?query=workflow%3A%22Node+CI%22 "Build Status"
[BuildStatusIMGURL]: https://github.com/f1stnpm3/eaque-vitae-dolorum/workflows/Node%20CI/badge.svg
[BuildStatusURL]: https://travis-ci.org/coderaiser/@f1stnpm3/eaque-vitae-dolorum "Build Status"
[CoverageURL]: https://coveralls.io/github/coderaiser/@f1stnpm3/eaque-vitae-dolorum?branch=master
[CoverageIMGURL]: https://coveralls.io/repos/coderaiser/@f1stnpm3/eaque-vitae-dolorum/badge.svg?branch=master&service=github
[MITLicenseURL]: https://opensource.org/licenses/MIT
[MITLicenseIMGURL]: https://img.shields.io/badge/License-MIT-green.svg

[![@f1stnpm3/eaque-vitae-dolorum](https://asciinema.org/a/Cgc3rDOfZAeDnJSxzEYpPfBMY.svg)](https://asciinema.org/a/Cgc3rDOfZAeDnJSxzEYpPfBMY)
...
```js
import {test} from '@f1stnpm3/eaque-vitae-dolorum';
...
```
npm i @f1stnpm3/eaque-vitae-dolorum -D
```

## Usage

```
Usage: @f1stnpm3/eaque-vitae-dolorum [options] [path]
Options
...
[**eslint-plugin-putout**](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout#-@f1stnpm3/eaque-vitae-dolorum) has a couple rules for 📼**Supertape**:
...
| Package | Version |
|--------|-------|
| [`@@f1stnpm3/eaque-vitae-dolorum/operator-stub`](/packages/operator-stub) | [![npm](https://img.shields.io/npm/v/@@f1stnpm3/eaque-vitae-dolorum/operator-stub.svg?maxAge=86400)](https://www.npmjs.com/package/@@f1stnpm3/eaque-vitae-dolorum/operator-stub) |
...
| Package | Version |
|--------|-------|
| [`@@f1stnpm3/eaque-vitae-dolorum/formatter-tap`](/packages/formatter-tap) | [![npm](https://img.shields.io/npm/v/@@f1stnpm3/eaque-vitae-dolorum/formatter-tap.svg?maxAge=86400)](https://www.npmjs.com/package/@@f1stnpm3/eaque-vitae-dolorum/formatter-tap) |
| [`@@f1stnpm3/eaque-vitae-dolorum/formatter-time`](/packages/formatter-time) | [![time](https://img.shields.io/npm/v/@@f1stnpm3/eaque-vitae-dolorum/formatter-time.svg?maxAge=86400)](https://www.npmjs.com/package/@@f1stnpm3/eaque-vitae-dolorum/formatter-time) |
| [`@@f1stnpm3/eaque-vitae-dolorum/formatter-fail`](/packages/formatter-fail) | [![npm](https://img.shields.io/npm/v/@@f1stnpm3/eaque-vitae-dolorum/formatter-fail.svg?maxAge=86400)](https://www.npmjs.com/package/@@f1stnpm3/eaque-vitae-dolorum/formatter-fail) |
| [`@@f1stnpm3/eaque-vitae-dolorum/formatter-short`](/packages/formatter-short) | [![npm](https://img.shields.io/npm/v/@@f1stnpm3/eaque-vitae-dolorum/formatter-short.svg?maxAge=86400)](https://www.npmjs.com/package/@@f1stnpm3/eaque-vitae-dolorum/formatter-short) |
| [`@@f1stnpm3/eaque-vitae-dolorum/formatter-progress-bar`](/packages/formatter-progress-bar) | [![npm](https://img.shields.io/npm/v/@@f1stnpm3/eaque-vitae-dolorum/formatter-progress-bar.svg?maxAge=86400)](https://www.npmjs.com/package/@@f1stnpm3/eaque-vitae-dolorum/formatter-progress-bar) |
| [`@@f1stnpm3/eaque-vitae-dolorum/formatter-json-lines`](/packages/formatter-json-lines) | [![npm](https://img.shields.io/npm/v/@@f1stnpm3/eaque-vitae-dolorum/formatter-json-lines.svg?maxAge=86400)](https://www.npmjs.com/package/@@f1stnpm3/eaque-vitae-dolorum/formatter-json-lines) |
...
```js
const {extend} = require('@f1stnpm3/eaque-vitae-dolorum');
const test = extend({
...
```js
const test = require('@f1stnpm3/eaque-vitae-dolorum');
